...
class BookingServiceTest {
    ...
    void shouldAddBooking() {
        ...
        Assertions.assertEquals(createdBooking.getId(), bookingDTO.getId());
        Assertions.assertEquals(createdBooking.getStart(), bookingDTO.getStart());
        Assertions.assertEquals(createdBooking.getEnd(), bookingDTO.getEnd());
        Assertions.assertEquals(createdBooking.getBooker(), bookingDTO.getBooker());
        Assertions.assertEquals(createdBooking.getItem(), bookingDTO.getItem());
        Assertions.assertEquals(createdBooking.getStatus(), bookingDTO.getStatus());
    }
    ...
    void shouldAddBookingWithIncorrectDate() {
        ...
        Assertions.assertEquals("Incorrect date or time for booking", exception.getMessage());
    }
    ...
    void shouldAddBookingWithOwnerBooker() {
        ...
        Assertions.assertEquals("Owner cannot book his item", exception.getMessage());
    }
    ...
    void shouldAddBookingWithItemAvailableFalse() {
        ...
        Assertions.assertEquals("Item available should be true", exception.getMessage());
    }
    ...
    void shouldChangeStatusReject() {
        ...
        Assertions.assertEquals(BookingStatus.REJECTED, updatedBooking.getStatus());
    }
    ...
    void shouldChangeStatusAlreadyApproved() {
        ...
        Assertions.assertEquals("Booking is already APPROVED", exception.getMessage());
    }
    ...
    void shouldChangeStatusWithNotOwnerItem() {
        ...
        Assertions.assertEquals("it's not the owner of the item", exception.getMessage());
    }
    ...
    void shouldReturnBooking() {
        ...
        Assertions.assertEquals(bookingDTO.getItem(), item);
        Assertions.assertEquals(bookingDTO.getBooker(), booker);
    }
    ...
    void shouldReturnBookingWithIncorrectUserId() {
        ...
        Assertions.assertEquals("User must be the owner or booker item", exception.getMessage());
    }
    ...
    void shouldReturnAllByBookerIdWithStateIncorrect() {
        ...
        Assertions.assertEquals("Incorrect state", exception.getMessage());
    }
